...
public final class MaterialTierUpgrader {
    ...
    private static Item itemFor(String category, String tier) {
        ...
        return switch (category) {
            ...
            case "boots" -> switch (t) { case "wood" -> null; case "stone" -> null; case "iron" -> Items.IRON_BOOTS; case "diamond" -> Items.DIAMOND_BOOTS; case "netherite" -> Items.NETHERITE_BOOTS; default -> null; };
            default -> null;
        };
    }
}
